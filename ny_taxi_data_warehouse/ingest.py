...
BUCKET_NAME = "yellow-ny-taxi-2024"

# Load GCP credentials from environment variable and initialize the storage client
CRED_NAME = "GCP_CREDENTIAL"
service_account_info = json.loads(os.environ[CRED_NAME])
